...
const SkinCancer = () => {
  ...
  useEffect(() => {
    axios
      .get(`${API_BASE_URL}/api/v1/skin-cancer/`)
      .then((response) => {
          ...
          <div className="skin-cancer-container">
            ...
            <div className="chart-selector">
              ...
              >
                ...
                <option value="Skin Cancer Cases by Age Group">
                  Skin Cancer Cases by Age Group
                </option>
            ...
            <div className="chart-container">
              {selectedChart === "Trend of Skin Cancer Cases" &&
                data.length > 0 && (
                  <div className="chart-item">
                    <h2>Trend of Skin Cancer Cases</h2>
              ...
              {selectedChart === "Skin Cancer Cases by Age Group" &&
                data.length > 0 && (
                  <div className="chart-item">
                    <h2>Skin Cancer Cases by Age Group</h2>
                    <ResponsiveContainer width="100%" height={400}>
                      <BarChart
                        data={data}
                        margin={{ top: 30, right: 30, left: 20, bottom: 5 }}
